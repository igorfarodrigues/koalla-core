...
fun ai.koalla.core.entity.Subscription.toDomain(): Subscription = Subscription(
    id = id!!,
    userId = userId,
...
fun ai.koalla.core.entity.Invoice.toDomain(): Invoice = Invoice(
    id = id!!,
    userId = userId,
...
fun AsaasCustomer.toDomain(): AsaasCustomerMapping = AsaasCustomerMapping(
    userId = userId,
...
fun SubStatus.toDomain(): SubscriptionStatus = when (this) {
...
fun SubscriptionStatus.toEntity(): SubStatus = when (this) {
