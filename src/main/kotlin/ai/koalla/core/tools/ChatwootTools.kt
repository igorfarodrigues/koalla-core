...
class ChatwootTools(
    ...
    fun sendText(): Function<SendTextRequest, String> =
        Function { req ->
    ...
    fun reactToMessage(): Function<ReactToMessageRequest, String> =
        Function { req ->
            val ctx = contextHolder.require()
    ...
    data class SetResponsePreferenceRequest(
        val preference: String = "texto",
    )
    ...
    fun setResponsePreference(): Function<SetResponsePreferenceRequest, String> =
        Function { req ->
            val ctx = contextHolder.require()
    ...
    data class SendCancellationAlertRequest(
        val message: String = "",
    )
    ...
    fun sendCancellationAlert(): Function<SendCancellationAlertRequest, String> =
        Function { req ->
            val ctx = contextHolder.require()
