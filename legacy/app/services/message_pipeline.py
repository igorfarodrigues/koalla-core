...
from legacy.app.database import AsyncSessionLocal
from legacy.app.models.message import MessageQueue, ConversationStatus
from legacy.app.models.user import User
from legacy.app.schemas.chatwoot import ChatwootWebhookBody
from legacy.app.services import chatwoot_client, agent_service
from legacy.app.services import audio_service
...
async def _reset_conversation(session_id: str, body: ChatwootWebhookBody) -> None:
    ...
    from legacy.app.models.message import ChatHistory
